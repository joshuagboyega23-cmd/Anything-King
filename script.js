...
.hero{
    padding-top: 4rem;
    background-image: URL('image/Screenshot_22-5-2026_231259_www.istockphoto.com.jpeg');
    height: 35rem;
...
.btn-3{
    background-color: rgba(255, 217, 0, 0.753);
    padding: 1rem 1rem;
    border-color: rgba(255, 217, 0, 0.753);
}
